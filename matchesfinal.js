...
function startCountdown() {
    ...
    matches.forEach((match) => {
        ...
        // ✅ لو في data-end هياخده، لو مفيش هيحسب start + 2 ساعة و10 دقائق تلقائي
        const matchEndDate = matchEndTime
            ? new Date(matchEndTime)
            : new Date(matchStartDate.getTime() + (2 * 60 + 10) * 60 * 1000);
        ...
        const interval = setInterval(() => {
            ...
            if (timeToEnd <= 0) {
                ...
                match.classList.remove("LIVE", "SOON", "NOT");
                ...
                match.classList.remove("SOON", "NOT", "END");
                ...
                match.classList.remove("LIVE", "NOT", "END");
                ...
                match.classList.remove("LIVE", "SOON", "END");
